...
Pastels, dreamy florals and tactile fabrics get paired with offbeat styling, such as graphic tees, clashing patterns and unexpected footwear. WGSN files it under maximalism and sees it as a precursor to future self-expression trends.

### Put-together City Dressing: preppy, relaxed

Preppy and sartorial codes are reworked into a soft, adaptable way of dressing for every day. Less literal varsity, more relaxed city prep, soft utility and refined silhouettes that go from work to dinner without a change.
...
The update is in the finishing. Raw edges, asymmetric trim placement and spliced construction add what WGSN calls "considered, imperfect character," so the heirloom look doesn't tip into sweetness.

> "A forecast doesn't need to be right on every count. Its job is to make you decide, before the first show, what you're actually waiting to see." — Guushu Design Team
